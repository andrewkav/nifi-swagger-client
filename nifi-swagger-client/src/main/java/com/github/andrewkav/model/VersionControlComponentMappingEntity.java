...
public class VersionControlComponentMappingEntity {
  public static final String SERIALIZED_NAME_VERSION_CONTROL_COMPONENT_MAPPING = "versionControlComponentMapping";
  @SerializedName(SERIALIZED_NAME_VERSION_CONTROL_COMPONENT_MAPPING)
  private Map<String, String> versionControlComponentMapping = new HashMap<String, String>();
