...
public class FlowConfigurationDTO {
  ...
  public static final String SERIALIZED_NAME_DEFAULT_BACK_PRESSURE_OBJECT_THRESHOLD = "defaultBackPressureObjectThreshold";
  @SerializedName(SERIALIZED_NAME_DEFAULT_BACK_PRESSURE_OBJECT_THRESHOLD)
  private Long defaultBackPressureObjectThreshold;

  public static final String SERIALIZED_NAME_DEFAULT_BACK_PRESSURE_DATA_SIZE_THRESHOLD = "defaultBackPressureDataSizeThreshold";
  @SerializedName(SERIALIZED_NAME_DEFAULT_BACK_PRESSURE_DATA_SIZE_THRESHOLD)
