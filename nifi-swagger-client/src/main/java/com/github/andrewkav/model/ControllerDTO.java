...
public class ControllerDTO {
  ...
  public static final String SERIALIZED_NAME_REMOTE_SITE_LISTENING_PORT = "remoteSiteListeningPort";
  @SerializedName(SERIALIZED_NAME_REMOTE_SITE_LISTENING_PORT)
  private Integer remoteSiteListeningPort;

  public static final String SERIALIZED_NAME_REMOTE_SITE_HTTP_LISTENING_PORT = "remoteSiteHttpListeningPort";
  @SerializedName(SERIALIZED_NAME_REMOTE_SITE_HTTP_LISTENING_PORT)
  private Integer remoteSiteHttpListeningPort;

  public static final String SERIALIZED_NAME_SITE_TO_SITE_SECURE = "siteToSiteSecure";
  @SerializedName(SERIALIZED_NAME_SITE_TO_SITE_SECURE)
