...
import com.github.andrewkav.model.AccessPolicyEntity;
...
public class PoliciesApi {
     ...
     */
    public okhttp3.Call removeAccessPolicyCall(String id, String version, String clientId, Boolean disconnectedNodeAcknowledged, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = new Object();
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call removeAccessPolicyValidateBeforeCall(String id, String version, String clientId, Boolean disconnectedNodeAcknowledged, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = removeAccessPolicyCall(id, version, clientId, disconnectedNodeAcknowledged, _callback);
        return localVarCall;
    ...
    public AccessPolicyEntity removeAccessPolicy(String id, String version, String clientId, Boolean disconnectedNodeAcknowledged) throws ApiException {
        ApiResponse<AccessPolicyEntity> localVarResp = removeAccessPolicyWithHttpInfo(id, version, clientId, disconnectedNodeAcknowledged);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<AccessPolicyEntity> removeAccessPolicyWithHttpInfo(String id, String version, String clientId, Boolean disconnectedNodeAcknowledged) throws ApiException {
        okhttp3.Call localVarCall = removeAccessPolicyValidateBeforeCall(id, version, clientId, disconnectedNodeAcknowledged, null);
        Type localVarReturnType = new TypeToken<AccessPolicyEntity>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call removeAccessPolicyAsync(String id, String version, String clientId, Boolean disconnectedNodeAcknowledged, final ApiCallback<AccessPolicyEntity> _callback) throws ApiException {

        okhttp3.Call localVarCall = removeAccessPolicyValidateBeforeCall(id, version, clientId, disconnectedNodeAcknowledged, _callback);
        Type localVarReturnType = new TypeToken<AccessPolicyEntity>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
