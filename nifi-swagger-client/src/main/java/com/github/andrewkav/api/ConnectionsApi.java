...
public class ConnectionsApi {
     ...
     */
    public okhttp3.Call deleteConnectionCall(String id, String version, String clientId, Boolean disconnectedNodeAcknowledged, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call deleteConnectionValidateBeforeCall(String id, String version, String clientId, Boolean disconnectedNodeAcknowledged, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteConnectionCall(id, version, clientId, disconnectedNodeAcknowledged, _callback);
        return localVarCall;
    ...
    public ConnectionEntity deleteConnection(String id, String version, String clientId, Boolean disconnectedNodeAcknowledged) throws ApiException {
        ApiResponse<ConnectionEntity> localVarResp = deleteConnectionWithHttpInfo(id, version, clientId, disconnectedNodeAcknowledged);
    ...
    public ApiResponse<ConnectionEntity> deleteConnectionWithHttpInfo(String id, String version, String clientId, Boolean disconnectedNodeAcknowledged) throws ApiException {
        okhttp3.Call localVarCall = deleteConnectionValidateBeforeCall(id, version, clientId, disconnectedNodeAcknowledged, null);
     ...
     */
    public okhttp3.Call deleteConnectionAsync(String id, String version, String clientId, Boolean disconnectedNodeAcknowledged, final ApiCallback<ConnectionEntity> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteConnectionValidateBeforeCall(id, version, clientId, disconnectedNodeAcknowledged, _callback);
        Type localVarReturnType = new TypeToken<ConnectionEntity>(){}.getType();
