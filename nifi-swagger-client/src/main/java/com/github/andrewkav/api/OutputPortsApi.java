...
public class OutputPortsApi {
     ...
     */
    public okhttp3.Call removeOutputPortCall(String id, String version, String clientId, Boolean disconnectedNodeAcknowledged, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = new Object();
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call removeOutputPortValidateBeforeCall(String id, String version, String clientId, Boolean disconnectedNodeAcknowledged, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = removeOutputPortCall(id, version, clientId, disconnectedNodeAcknowledged, _callback);
        return localVarCall;
    ...
    public PortEntity removeOutputPort(String id, String version, String clientId, Boolean disconnectedNodeAcknowledged) throws ApiException {
        ApiResponse<PortEntity> localVarResp = removeOutputPortWithHttpInfo(id, version, clientId, disconnectedNodeAcknowledged);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<PortEntity> removeOutputPortWithHttpInfo(String id, String version, String clientId, Boolean disconnectedNodeAcknowledged) throws ApiException {
        okhttp3.Call localVarCall = removeOutputPortValidateBeforeCall(id, version, clientId, disconnectedNodeAcknowledged, null);
        Type localVarReturnType = new TypeToken<PortEntity>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call removeOutputPortAsync(String id, String version, String clientId, Boolean disconnectedNodeAcknowledged, final ApiCallback<PortEntity> _callback) throws ApiException {

        okhttp3.Call localVarCall = removeOutputPortValidateBeforeCall(id, version, clientId, disconnectedNodeAcknowledged, _callback);
        Type localVarReturnType = new TypeToken<PortEntity>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call updateRunStatusCall(String id, PortRunStatusEntity body, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateRunStatusValidateBeforeCall(String id, PortRunStatusEntity body, final ApiCallback _callback) throws ApiException {
     ...
     */
    public okhttp3.Call updateRunStatusAsync(String id, PortRunStatusEntity body, final ApiCallback<ProcessorEntity> _callback) throws ApiException {
