...
public class LabelsApi {
     ...
     */
    public okhttp3.Call removeLabelCall(String id, String version, String clientId, Boolean disconnectedNodeAcknowledged, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = new Object();
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call removeLabelValidateBeforeCall(String id, String version, String clientId, Boolean disconnectedNodeAcknowledged, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = removeLabelCall(id, version, clientId, disconnectedNodeAcknowledged, _callback);
        return localVarCall;
    ...
    public LabelEntity removeLabel(String id, String version, String clientId, Boolean disconnectedNodeAcknowledged) throws ApiException {
        ApiResponse<LabelEntity> localVarResp = removeLabelWithHttpInfo(id, version, clientId, disconnectedNodeAcknowledged);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<LabelEntity> removeLabelWithHttpInfo(String id, String version, String clientId, Boolean disconnectedNodeAcknowledged) throws ApiException {
        okhttp3.Call localVarCall = removeLabelValidateBeforeCall(id, version, clientId, disconnectedNodeAcknowledged, null);
        Type localVarReturnType = new TypeToken<LabelEntity>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call removeLabelAsync(String id, String version, String clientId, Boolean disconnectedNodeAcknowledged, final ApiCallback<LabelEntity> _callback) throws ApiException {

        okhttp3.Call localVarCall = removeLabelValidateBeforeCall(id, version, clientId, disconnectedNodeAcknowledged, _callback);
        Type localVarReturnType = new TypeToken<LabelEntity>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
