...
public class InputPortsApi {
     ...
     */
    public okhttp3.Call removeInputPortCall(String id, String version, String clientId, Boolean disconnectedNodeAcknowledged, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = new Object();
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call removeInputPortValidateBeforeCall(String id, String version, String clientId, Boolean disconnectedNodeAcknowledged, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = removeInputPortCall(id, version, clientId, disconnectedNodeAcknowledged, _callback);
        return localVarCall;
    ...
    public PortEntity removeInputPort(String id, String version, String clientId, Boolean disconnectedNodeAcknowledged) throws ApiException {
        ApiResponse<PortEntity> localVarResp = removeInputPortWithHttpInfo(id, version, clientId, disconnectedNodeAcknowledged);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<PortEntity> removeInputPortWithHttpInfo(String id, String version, String clientId, Boolean disconnectedNodeAcknowledged) throws ApiException {
        okhttp3.Call localVarCall = removeInputPortValidateBeforeCall(id, version, clientId, disconnectedNodeAcknowledged, null);
        Type localVarReturnType = new TypeToken<PortEntity>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call removeInputPortAsync(String id, String version, String clientId, Boolean disconnectedNodeAcknowledged, final ApiCallback<PortEntity> _callback) throws ApiException {

        okhttp3.Call localVarCall = removeInputPortValidateBeforeCall(id, version, clientId, disconnectedNodeAcknowledged, _callback);
        Type localVarReturnType = new TypeToken<PortEntity>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
